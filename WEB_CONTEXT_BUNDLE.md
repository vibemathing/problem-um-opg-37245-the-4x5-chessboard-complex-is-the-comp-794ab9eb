...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37245"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-v1",
      "problem_contract_sha256": "30cdae6234960f9df3ebfccf7a7ea4183e20515c676b1125758f8624785cf71a",
      "problem_id": "problem:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb",
      "route_id": "route:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-source-fidelity-01",
      "graph_id": "graph:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Problem Ian Agol and Matthias Goerner observed that the 4x5 chessboard complex is the complement of many distinct links in the 3-sphere. Their observation is non-constructive, as it uses the resolution of the Poincare Conjecture. Find specific links that have the 4x5 chessboard complex as their complement."
          },
          "statement_sha256": "c49f7bcf98ddaae50757862e6cb0db7530097de5db2deacb9895827837d37ca2"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-root",
      "route_id": "route:um-opg-37245-the-4x5-chessboard-complex-is-the-comp-794ab9eb-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37245-19524ea65004",
        "url": "https://www.unsolvedmath.com/problems/OPG-37245"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
